...
export declare type ControlOptionsAll = keyof Control | ControlOptions;
...
declare const _default: React.ForwardRefExoticComponent<(MapProps & RenderProps) & React.RefAttributes<MapProps & {
